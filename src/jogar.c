...
/**
 * Inicia o vetor que evita repetições de tiros da IA.*/
 void iniciavetor(){
 	int i;
 	for(i=0;i<100;i++){
 		vetor[i]=i;
...
/**
 * Função que dinamisa as rodadas.\n
...
/**
 * funïção uzada para testar se o barco foi destuido ou acertado.
 */
...
/**
 * Imprime o menu e pede ao player a opïção desejada.
 */
 void menu(){
 	int x;
 	x=1;
...
/**
 * Funïção responsï¿½vel por salvar os dados da partida dentro de um arquivo que pode ser lido posteriormente.
 */
 void salvar(){
 	int i,j;
 	FILE *arq;
